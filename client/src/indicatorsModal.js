      ...
      <div class="modal-box" style="width: 720px; max-height: 85vh; display: flex; flex-direction: column;">
        ...
        <div class="modal-header">
          <h3>
            ...
            Indicators, Metrics & Strategies (${INDICATORS_LIBRARY.length}+)
          </h3>
        ...
        <div style="padding: 12px 20px; background: var(--bg-darkest); border-bottom: 1px solid var(--border-subtle); display: flex; gap: 10px; align-items: center;">
          <div style="flex: 1; position: relative; display: flex; align-items: center;">
            <input type="text" id="ind-search-input" placeholder="Search 84+ indicators (RSI, SMC, Supertrend, EMA, MACD, ICT)..." style="width: 100%; height: 36px; padding: 6px 32px 6px 12px; font-size: 13px;" />
          ...
          <select id="ind-cat-select" style="height: 36px; font-size: 12px; padding: 6px 10px;">
            <option value="all">All Categories (${INDICATORS_LIBRARY.length})</option>
        ...
        <div style="padding: 6px 20px; font-size: 11px; color: var(--text-dim); background: var(--bg-surface); border-bottom: 1px solid var(--border-subtle); display: flex; justify-content: space-between;">
          <span id="ind-count-label">Showing ${INDICATORS_LIBRARY.length} indicators</span>
